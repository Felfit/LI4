...
CREATE TABLE Receita (id int IDENTITY NOT NULL, imagemLink varchar(255) NOT NULL, videoLink varchar(255) NOT NULL, descricao varchar(255) NOT NULL, nome varchar(60) NOT NULL, dificuldade int NOT NULL, porcoes int NOT NULL, tempodepreparacao int NOT NULL, tempodeespera int NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Nutricao (Receitaid int NOT NULL, energia int NOT NULL, gordura int NOT NULL, hidratosCarbono int NOT NULL, PRIMARY KEY (Receitaid));
...
ALTER TABLE Nutricao ADD CONSTRAINT FKNutricao138526 FOREIGN KEY (Receitaid) REFERENCES Receita (id);
