...
CREATE TABLE Utilizador (id int IDENTITY NOT NULL, Nome varchar(60) NOT NULL, email varchar(50) NOT NULL UNIQUE, password varchar(50) NOT NULL UNIQUE, dataNascimento datetime NOT NULL, PRIMARY KEY (id));
CREATE TABLE Ingrediente (id int IDENTITY NOT NULL, Unidadeid int NOT NULL, nome varchar(64) NOT NULL, imageLink varchar(255) NOT NULL, PRIMARY KEY (id));
